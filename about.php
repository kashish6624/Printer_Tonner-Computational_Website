...
<script>
    // Function to ask or share information
    function getUserInput() {
        // Ask the user for input
        var userInput = prompt("What information would you like to ask or share about CCET Chandigarh?");
        ...
        if (userInput !== null && userInput.trim() !== "") {
            ...
            // Inform the user if they didn't enter anything
            alert("You didn't provide any information.");
        }
    }
</script>
